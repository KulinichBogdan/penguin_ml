...
if penguin_file is None:
    ...
    st.write('We trained a Random Forest model on these data, it has a score of {}! Use the imputs below to try out the model.'.format(score))
...
fig, ax = plt.subplots()
ax = sns.displot(x=penguin_df['species'])
